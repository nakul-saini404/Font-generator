...
export default function AllFonts() {
  ...
  const handleCopy = (fonts) => {
  const html = `<div style="font-family:'${fonts}'; font-size:22px;">${text}</div>`;
  ...
  navigator.clipboard.write([clipboardItem])
    .then(() => alert("Copied with style (HTML)!"))
        ...
        {fonts.map((font, i) => (
          ...
          <Grid size={{ xs: 12 }} key={i} width={"100%"}>
            ...
            >
              ...
              <IconButton onClick={() => handleCopy(font)} size="small">
